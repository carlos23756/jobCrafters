<template>
    <div>
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <path d="M15.9398 12.413H15.9488" stroke="#53545C" stroke-width="2" stroke-linecap="round"
                stroke-linejoin="round" />
            <path d="M11.9301 12.413H11.9391" stroke="#53545C" stroke-width="2" stroke-linecap="round"
                stroke-linejoin="round" />
            <path d="M7.92128 12.413H7.93028" stroke="#53545C" stroke-width="2" stroke-linecap="round"
                stroke-linejoin="round" />
        </svg>
    </div>
</template>
