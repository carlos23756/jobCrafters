            ...
            <div class="p-0">
                ...
                <div class="flex bg-gray-100 relative h-10 rounded-b-lg" style="top: -23px;">
                    <div class="w-5/6 pt-2">
                        <div>
                            <span class="inline-flex items-center relative rounded-md 
                            bg-blue-600 px-2 py-1 ml-2 mb-2 text-xs font-bold 
                            text-white">
                                PDF
                            </span>
                        </div>
                    ...
                    <div>
                        <div v-if="selected" class="pt-2">
                            <svg id="fi_4315445" enable-background="new 0 0 512 512" viewBox="0 0 512 512" width="20"
